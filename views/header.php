...
<header >
       <div class="header-component">
            ...
            <a class="nav-item" href="/views/foodpage.php">Foods</a>
            <a class="nav-item" href="/">Hotels</a>
            <a class="nav-item" href="/views/basketpage.php">Basket</a>
            <a class="nav-item" href="/views/login.php">Login</a>
            </nav>
